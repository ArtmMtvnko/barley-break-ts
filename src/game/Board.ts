...
export class MidBoard extends Board {
    ...
    constructor() {
        ...
        this.field = [
            ...
            [new Brick(16), new Brick(17), new Brick(18), new Brick(19), new Brick(0)],
            [new Brick(21), new Brick(22), new Brick(23), new Brick(24), new Brick(20)]
        ]
    }
}
...
export class LargeBoard extends Board {
    ...
    constructor() {
        ...
        this.field = [
            ...
            [new Brick(25), new Brick(26), new Brick(27), new Brick(28), new Brick(29), new Brick(0)],
            [new Brick(31), new Brick(32), new Brick(33), new Brick(34), new Brick(35), new Brick(30)],
        ]
    }
}